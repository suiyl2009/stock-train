...
int CIndexData::GetDayIdx(int nDate)
{
    ...
    {
        t = (i+j)/2;
        if (m_vecDayData[t].date == nDate)
        {
            return t;
        }
        else if (m_vecDayData[t].date > nDate)
        {
            i = t+1;
        }
        else
    ...
    if ((t<m_vecDayData.size()) && (m_vecDayData[t].date<nDate))
    {
        if ((t-1>=0) && (m_vecDayData[t-1].date>nDate))
        {
            return t;
        }
    }
    if ((t+1<m_vecDayData.size()) && (m_vecDayData[t].date>nDate))
    {
        if (m_vecDayData[t+1].date<nDate)
        {
            return (t+1);
        }
    }
